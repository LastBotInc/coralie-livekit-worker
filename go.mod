module github.com/LastBotInc/coralie-livekit-worker

go 1.25

require (
	coralie-conference-service v0.0.0
	github.com/LastBotInc/coralie-logging-go v0.0.0
...
replace coralie-conference-service => ../coralie-conference-service

replace github.com/LastBotInc/coralie-logging-go => ../coralie-logging-go
